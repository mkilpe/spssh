...
ssh_config test_tool_default_config() {
	...
	c.algorithms.kexes = {kex_type::curve25519_sha256, kex_type::dh_group16_sha512, kex_type::dh_group14_sha256};
	c.algorithms.client_server_ciphers = {cipher_type::aes_256_gcm, cipher_type::aes_256_ctr};
	c.algorithms.server_client_ciphers = {cipher_type::aes_256_gcm, cipher_type::aes_256_ctr};
