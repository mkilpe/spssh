...
std::string_view to_string(key_exchange_type t) {
	...
	if(t == dh_group14) return "diffie-hellman-group14";
	if(t == dh_group16) return "diffie-hellman-group16";
	return "unknown";
}
...
key_exchange_type from_string(type_tag<key_exchange_type>, std::string_view s) {
	...
	if(s == "diffie-hellman-group14") return dh_group14;
	if(s == "diffie-hellman-group16") return dh_group16;
	return unknown;
}
