...
const_span modp_group_14_modulus() {
	static unsigned char const modulus_array[] = {
	...
	return const_span{(std::byte const*)modulus_array, sizeof(modulus_array)};
}

const_span modp_group_14_generator() {
	static unsigned char const generator_array[] = { 0x02 };

	return const_span{(std::byte const*)generator_array, sizeof(generator_array)};
}
